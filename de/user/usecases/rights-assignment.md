...
TODO [![Benutzer erstellen](../../img/screenshots/rights-assignment/create-new-user.png)](../../img/screenshots/rights-assignment/create-new-user.png)

Nun konfigurieren wir die Berechtigungen unter Benutzerverwaltung -> Berechtigungen

Unsere Gruppe **"Buchhaltung"** sollte Buchhaltungsdaten lesen, erstellen und ändern können. Außerdem sollte sie den Standort von Anlagen ermitteln können. Alle anderen Informationen sollten für diese Gruppe nicht sichtbar sein.

Der erste Schritt besteht darin, den grundlegenden Zugriff auf Anlagen zu definieren. Zu diesem Zweck erstellen wir eine neue Berechtigung.

Hier gewähren wir Lesezugriff auf alle Objekte in der Kategorie "Allgemein". Dies ist erforderlich, damit grundlegende Anlageninformationen wie der Name sichtbar sind.

TODO [![Berechtigungen erstellen](../../img/screenshots/rights-assignment/create-new-permission-accounting.png)](../../img/screenshots/rights-assignment/create-new-permission-accounting.png)
...
# Zugriff auf die Buchhaltung konfigurieren
...
TODO [![Berechtigungen erstellen](../../img/screenshots/rights-assignment/create-new-permission-accounting-2.png)](../../img/screenshots/rights-assignment/create-new-permission-accounting-2.png)

# Zugriff auf Standort konfigurieren
...
TODO [![Berechtigungen erstellen](../../img/screenshots/rights-assignment/create-new-permission-location.png)](../../img/screenshots/rights-assignment/create-new-permission-location.png)
...
TODO [![Berechtigungen erstellen](../../img/screenshots/rights-assignment/permissions-config-accounting.gif)](../../img/screenshots/rights-assignment/permissions-config-accounting.gif)
...
TODO [![Anmeldung mit neuem Benutzer](../../img/screenshots/rights-assignment/test-permissions.png)](../../img/screenshots/rights-assignment/test-permissions.png)

| **Test** | **Ergebnis** |
| --- | --- |
| Beim Versuch, ein neues Objekt in einer beliebigen Klasse zu erstellen oder zu löschen, wird die Meldung angezeigt, dass Sie nicht über ausreichende Berechtigungen für diese Aktion verfügen. | [![TEXT](../../img/screenshots//rights-assignment/limited-permissions.png)](../../img/screenshots/rights-assignment/limited-permissions.png) |
| Beim Aufruf eines Objekts sollten nun nur noch die Kategorien "Allgemein", "Buchhaltung" und "Standort" Informationen anzeigen. Beim Versuch, die Kategorie "Standort" zu bearbeiten, sollte angezeigt werden, dass der Benutzer nicht über ausreichende Berechtigungen verfügt. | [![TEXT](../../img/screenshots/rights-assignment/no-permissions.png)](../../img/screenshots/rights-assignment/no-permissions.png)|
...
TODO [![TEXT](../../img/screenshots/rights-assignment/display-with-no-permission.png)](../../img/screenshots/rights-assignment/display-with-no-permission.png)
...
TODO [![TEXT](../../img/screenshots/rights-assignment/create-new-user-group.png)](../../img/screenshots/rights-assignment/create-new-user-group.png)
...
TODO [![TEXT](../../img/screenshots/rights-assignment/edit-user-group.png)](../../img/screenshots/rights-assignment/edit-user-group.png)
