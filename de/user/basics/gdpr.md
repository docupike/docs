...
Das Datenschutz-Add-on ist für alle **Test**-Nutzer 30 Tage lang verfügbar.

Für **Premium**- und **Pro**-Nutzer ist es uneingeschränkt verfügbar.
...
Alle [Klassen](../basics/classes.md), die zu **Datenschutz** gehören, werden in der [Sammlung](../basics/collections.md) "Datenschutz" gespeichert, die im Menü [Finder](../finder/views-and-presets.md) zu finden ist.
...
Alle [Klassen](../basics/classes.md), die zu **Datenschutz** gehören, werden in der [Sammlung](../basics/collections.md) **Datenschutz** gespeichert, die Sie im Menü [Finder](../finder/views-and-presets.md) finden.
