...
Click any class entry.
The Finder table updates to show only objects of that class.
The right-pane heading changes from *All objects* to the class name and a **★ Favorite** star appears next to the class name, see [Favorites](../basics/favorites.md).
