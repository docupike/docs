...
All [Classes](basics/classes.md) that belong to **Data protection** are stored in the data protection [Collection](basics/collections.md) which can be found in the [Finder](finder/finder.md) menu.
